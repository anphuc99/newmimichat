...
import { createListeningController } from "../../../../server/src/controllers/listening/listening.controller";
...
/**
 * Constructs the listening controller using three mock repositories.
 *
...
describe("Listening controller", () => {
  ...
  it("creates a new card when reviewing a new message", async () => {
    ...
    await controller.reviewListening(authRequest({ body: { rating: 3, messageId: "msg-1" } }), response);
