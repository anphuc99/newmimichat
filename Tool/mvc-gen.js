...
const updateRoutesIndex = (rootDir, groupName, pascalGroup) => {
  ...
  const importLine = `import { create${pascalGroup}Routes } from "./${groupName}.routes";`;
